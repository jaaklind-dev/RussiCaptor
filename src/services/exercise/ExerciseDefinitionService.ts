...
export const EXERCISE_DEFINITION_CATALOG: ExerciseDefinitionCatalog = Object.freeze({
  patientProcesses: Object.freeze(["BOTULISM_ROOT", "HEMORRHAGE", "HYPOVENTILATION_HYPERCAPNIA", "HYPOXIA", "MEDICATION", "RESPIRATORY_FAILURE"]),
...
export const DEFAULT_EXERCISE_DEFINITION: ExerciseDefinition = Object.freeze({
  ...
  enabledPatientProcesses: Object.freeze([...EXERCISE_DEFINITION_CATALOG.patientProcesses]), enabledAnalyticsProviders: Object.freeze([...EXERCISE_DEFINITION_CATALOG.analyticsProviders]), enabledMetricProviders: Object.freeze([...EXERCISE_DEFINITION_CATALOG.metricProviders]),
