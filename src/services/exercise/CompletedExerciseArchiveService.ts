...
export function restoreCompletedExerciseArchives(values: readonly CompletedExerciseArchive[]): void { archives.clear(); values.forEach(value => archives.set(value.exerciseId, deepFreeze(structuredClone(value)) as CompletedExerciseArchive)); }
export function clearCompletedExerciseArchives(): void { archives.clear(); }
